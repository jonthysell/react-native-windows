...
// [Windows We will create module.exports, extended with Windows APIs
const rnExports = {
  // Windows]
  // #region Components
...
// [Windows Here we finally define module.exports with additional windows exports (typed any for flow)
...
// [Windows
// Some 'react-native' modules use these flow types and expect the 'react-native' module
// to export them, but this doesn't work outside the 'react-native' monorepo, so we need
// to export them here ourselves to pass flow-check.
